# Day-1 Python for Data Science, ML, DL and AI:
...
# Day-2: Numpy Basic Introduction
...
>>> a[-1][1][-2]
```
### 2. Accessing elements of ndarray by using slice operator:
a[begin:end:step]
```py
## 1-D array:
